    ...
    # 需要调用mcp 服务进行回答
        ...
        async with mcp_server:
            ...
            async for event in result.stream_events():
                ...
                # tool_output
                if event.type == "raw_response_event" and hasattr(event, 'assert') and isinstance(event.data, ResponseOutputItemDoneEvent):
                ...
                if event.type == "raw_response_event" and hasattr(event, 'assert') and isinstance(event.data, ResponseTextDeltaEvent):
